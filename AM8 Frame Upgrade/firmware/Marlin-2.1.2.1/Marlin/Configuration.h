...
#define CUSTOM_MACHINE_NAME "Tronxy AM8"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 394.18 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, 20, -1.125 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 280   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
